...
if ( Yii::$app->user->isGuest ) {
	echo Html::a(Yii::t('app', 'User SignIn'), $signInRoute) .' | '. Html::a(Yii::t('app', 'User SignUp'), $signUpRoute);
} else {
	echo Yii::t('app', 'User SignIn As').' '.
		Html::a(Html::tag('strong', Yii::$app->user->identity->username), $viewRoute);
	echo Html::tag('br');
	echo Html::a(Yii::t('app', 'User Profile'), $updateRoute) .' | '. Html::a(Yii::t('app', 'User SignOut'), $signOutRoute, ['data' => ['method' => 'post']]);
}