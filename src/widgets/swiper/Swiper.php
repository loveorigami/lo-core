...
class Swiper extends Widget
{
     ...
     *                               you should use [[\lo\core\widgets\swiper\Swiper::addItem]]
     *                               instead of direct items pushing.
     *
     * @see \lo\core\widgets\swiper\Slide
     * @see \lo\core\widgets\swiper\Swiper::$itemOptions
     * @see \lo\core\widgets\swiper\Swiper::addItem
     * @see \lo\core\widgets\swiper\Swiper::renderItem
     */
    public $items = [ ];

    /**
     * @var mixed[] options, which first will be merged with [[\lo\core\widgets\swiper\Slide::$options]]
     *              for each slide, and then applied in [[\yii\helpers\Html::tag]] for rendering.
     *
     * @see \lo\core\widgets\swiper\Swiper::normalizeOptions
     * @see \lo\core\widgets\swiper\Swiper::renderItem
     *
     * @see \lo\core\widgets\swiper\Slide::$options
     */
    public $itemOptions = [ ];
     ...
     *              value with custom.
     *
     * @see \lo\core\widgets\swiper\Swiper::run
     */
     ...
     * @var mixed[] Options which will be applied in [[\yii\helpers\Html::tag]].
     *
     * @see \lo\core\widgets\swiper\Swiper::renderWrapper
     */
     ...
     *
     * @see \lo\core\widgets\swiper\Swiper::registerClientScript
     */
     ...
     *
     *               ~~~
     *               \lo\core\widgets\swiper\Swiper::widget([
     ...
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_PAGINATION]]
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_SCROLLBAR]]
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_NEXT_BUTTON]]
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_PREV_BUTTON]]
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_RTL]]
     *               - [[\lo\core\widgets\swiper\Swiper::BEHAVIOUR_PARALLAX]]
     *
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_PAGINATION
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_SCROLLBAR
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_NEXT_BUTTON
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_PREV_BUTTON
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_RTL
     * @see \lo\core\widgets\swiper\Swiper::BEHAVIOUR_PARALLAX
     */
    public $behaviours = [ ];
    ...
    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] parallax item
     *
     * @see \lo\core\widgets\swiper\Swiper::PARALLAX_BACKGROUND
     * @see \lo\core\widgets\swiper\Swiper::PARALLAX_TRANSITION
     * @see \lo\core\widgets\swiper\Swiper::PARALLAX_TRANSITION_X
     * @see \lo\core\widgets\swiper\Swiper::PARALLAX_TRANSITION_Y
     * @see \lo\core\widgets\swiper\Swiper::PARALLAX_DURATION
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     * @see \lo\core\widgets\swiper\Swiper::$parallaxOptions
     *
     * @see \lo\core\widgets\swiper\Swiper::renderBehaviourParallax
     */
    ...
    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] pagination item
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     * @see \lo\core\widgets\swiper\Swiper::$paginationOptions
     *
     * @see \lo\core\widgets\swiper\Swiper::renderBehaviourPagination
     */
     ...
     *              ~~~
     *
     * @see \lo\core\widgets\swiper\Swiper::$scrollbarOptions
     */
    public $paginationOptions = [ ];


    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] scrollbar item
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     * @see \lo\core\widgets\swiper\Swiper::$scrollbarOptions
     *
     * @see \lo\core\widgets\swiper\Swiper::renderBehaviourScrollbar
     */
    ...
    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] nextButton item
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     * @see \lo\core\widgets\swiper\Swiper::$nextButtonOptions
     *
     * @see \lo\core\widgets\swiper\Swiper::renderBehaviourNextButton
     */
     ...
     *              ~~~
     *
     * @see \lo\core\widgets\swiper\Swiper::$prevButtonOptions
     */
    public $nextButtonOptions = [ ];


    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] prevButton item
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     * @see \lo\core\widgets\swiper\Swiper::$prevButtonOptions
     *
     * @see \lo\core\widgets\swiper\Swiper::renderBehaviourPrevButton
     */
    ...
    /**
     * Named alias for [[\lo\core\widgets\swiper\Swiper::$behaviours]] rtl item
     *
     * @see \lo\core\widgets\swiper\Swiper::$behaviours
     *
     * @see \lo\core\widgets\swiper\Swiper::setBehaviourRtl
     */
    const BEHAVIOUR_RTL = 'rtl';


    /**
     * This function is batch-wrapper of \lo\core\widgets\swiper\Swiper::addItem
     *
     * @param string[]|mixed[][]|Slide[] $items batch of items
     *                                          to be added into slider
     *
     * @see \lo\core\widgets\swiper\Swiper::addItem
     * @see \lo\core\widgets\swiper\Swiper::$items
     * @see \lo\core\widgets\swiper\Slide
     *
     * @return Swiper
     */
     ...
     *
     * Also it merges [[\lo\core\widgets\swiper\Swiper::$itemOptions]]
     * with concrete item options.
     *
     * @param string|mixed[]|Slide $item The content, or configuration,
     *                                   or [[\lo\core\widgets\swiper\Slide]] itself.
     *
     * @see \lo\core\widgets\swiper\Swiper::$items
     * @see \lo\core\widgets\swiper\Slide
     *
     ...
     *
     * @see \lo\core\widgets\swiper\Swiper::checkBehaviours
     *
     * @see \lo\core\widgets\swiper\Swiper::normalizeOptions
     * @see \lo\core\widgets\swiper\Swiper::normalizeItems
     */
     ...
     *
     * @see \lo\core\widgets\swiper\Swiper::$containerOptions
     * @see \lo\core\widgets\swiper\Swiper::$wrapperOptions
     * @see \lo\core\widgets\swiper\Swiper::$paginationOptions
     * @see \lo\core\widgets\swiper\Swiper::$scrollbarOptions
     * @see \lo\core\widgets\swiper\Swiper::$nextButtonOptions
     * @see \lo\core\widgets\swiper\Swiper::$prevButtonOptions
    ...
    /**
     * This function converts non-[[\lo\core\widgets\swiper\Slide]] items
     * to [[\lo\core\widgets\swiper\Slide]] respectively
     *
     * Then it merges [[\lo\core\widgets\swiper\Swiper::$itemOptions]] with
    ...
    /**
     * This function converts non-[[\lo\core\widgets\swiper\Slide]] item
     * to [[\lo\core\widgets\swiper\Slide]], merging batch options,
    ...
    {
        /**
         * If concrete \lo\core\widgets\swiper\Slide given
    ...
    /**
     * This function adds [[dir=rtl]] tag option to [[\lo\core\widgets\swiper\Swiper::$containerOptions]]
     *
     ...
     *
     * @see \lo\core\widgets\swiper\Swiper::$wrapperOptions
     * @see \lo\core\widgets\swiper\Swiper::renderItems
     *
     * @return string
     */
    ...
    /**
     * This function just calls [[\lo\core\widgets\swiper\Swiper::renderItem]]
     * for each [[\lo\core\widgets\swiper\Swiper::$items]] and returns
     * formatter result
     *
     * @param Slide[] $items
     *
     ...
     *
     * @see \lo\core\widgets\swiper\Swiper::$pluginOptions
     * @return Swiper
     */
...
JS
     ...
     * in [[\lo\core\widgets\swiper\Swiper::$pluginOptions]]
     *
     * @see \lo\core\widgets\swiper\Swiper::OPTION_DIRECTION
     * @see \lo\core\widgets\swiper\Swiper::$pluginOptions
     */
     ...
     * in [[\lo\core\widgets\swiper\Swiper::$pluginOptions]]
     *
     * @see \lo\core\widgets\swiper\Swiper::OPTION_EFFECT
     * @see \lo\core\widgets\swiper\Swiper::$pluginOptions
     */
     ...
     * in [[\lo\core\widgets\swiper\Swiper::$pluginOptions]]
     *
     * @see \lo\core\widgets\swiper\Swiper::OPTION_SLIDES_PER_VIEW
     * @see \lo\core\widgets\swiper\Swiper::$pluginOptions
     */
     ...
     * in [[\lo\core\widgets\swiper\Swiper::$pluginOptions]]
     *
     * @see \lo\core\widgets\swiper\Swiper::OPTION_SLIDES_PER_COLUMN_FILL
     * @see \lo\core\widgets\swiper\Swiper::$pluginOptions
     */
