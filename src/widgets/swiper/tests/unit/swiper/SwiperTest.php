<?php
namespace lo\core\widgets\swiper\tests\unit\swiper;
...
class SwiperTest extends BaseTestCase
{
    ...
    public function testInvalidItemsInjectionFailed()
    {
        ...
        $this->setExpectedException( 'yii\base\ErrorException', 'must be an instance of lo\core\widgets\swiper\Slide' );
